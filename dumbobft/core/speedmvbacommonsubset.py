...
def speedmvbacommonsubset(sid, pid, shard_id, N, f, PK, SK, PK1, SK1, PK2s, SK2, input, decide, receive, send, predicate=lambda i, v: True, logger=None):
    ...
    vaba = gevent.spawn(speedmvba, sid + 'VACS-VABA', pid, shard_id, N, f, PK, SK, PK2s, SK2,
